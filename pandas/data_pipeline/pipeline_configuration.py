...
# ---------------------------------------------------------------------------
BYPASS_TRIM_LARGE_CLASSES = True
LARGE_CLASSSIZE_THRESHOLD = 1024 * 32
LARGE_CLASS_REDUCTION_GOAL = 0.20
# ---------------------------------------------------------------------------
...
FACTORSELECTOR_CATEGORICAL_LIMIT = 256
...
# ---------------------------------------------------------------------------
BYPASS_SQUARING_AFTERTOP = 30
BYPASS_INTERACTIONS_AFTERTOP = 30
EXAMINE_HIGHER_TERMS_UPTO = 10
# ---------------------------------------------------------------------------
BYPASS_ADD_CLASSLABEL_DIFFERENTIATORS = False
BYPASS_ADD_CENTROIDS = True
...
# ---------------------------------------------------------------------------
MAX_NUM_FACTOR_LEVELS = int(1024*4.0000)
...
CENTROID_APPROACH = "centroid"
NC1_CLUSTERS = 8
NC0_CLUSTERS = 8
MAX_SAMPLES_TO_CLUSTER = 256
PERCLASS_RANDOM_CENTROIDS = int(max(MAX_SAMPLES_TO_CLUSTER/NC1_CLUSTERS, 32))*8
MIN_VALID_CLUSTER_SIZE = 64
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
BYPASS_DECORRELATION_ON_NTOP = 50
...
BYPASS_INTERMEDIARY_DECORRELATION = True
...
FS_STEPS = {'origvars':              8192,
            ...
            'final':                 8192}
# ---------------------------------------------------------------------------
FSELECT_MINSCORE = 30000
# ---------------------------------------------------------------------------
FS_MINSCORES = {'origvars':           500.0,
