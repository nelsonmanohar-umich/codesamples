...
(define-project :name :|LISP - HPS DNA_PATTERN_MATCH|
  :modules (list (make-instance 'module :name "HPS_DNA_readme.lisp")
                 ...
                 (make-instance 'module :name "HPS_copyrigth.lisp")
                 (make-instance 'module :name
                 ...
                 (make-instance 'module :name
                                "..\\LISP - HPS TRANSFORM - VER-09-07\\HPS_DNA_conditioning_encoder.lisp")
                 (make-instance 'module :name
                                "..\\LISP - HPS TRANSFORM - VER-09-07\\HPS_system_dependent.lisp")
                 (make-instance 'module :name "HPS_DNA_init.lisp")
                 (make-instance 'module :name "HPS_DNA_utilities.lisp")
                 (make-instance 'module :name
                 ...
                 (make-instance 'module :name
                                "HPS_DNA_report_headers.lisp")
                 (make-instance 'module :name
                                "HPS_DNA_gnuplot_headers.lisp")
                 (make-instance 'module :name
                                "HPS_DNA_genbank_reader.lisp")
                 (make-instance 'module :name "HPS_DNA_gnuplot.lisp")
                 (make-instance 'module :name "HPS_DNA_aligner.lisp")
                 (make-instance 'module :name "HPS_DNA_report.lisp")
                 (make-instance 'module :name
                                "HPS_DNA_pattern_mining.lisp")
                 (make-instance 'module :name "HPS_DNA_main.lisp")
                 (make-instance 'module :name "HPS_DNA_zdriver.lisp"))
  :projects nil
  :libraries nil
