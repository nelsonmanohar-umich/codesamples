...
(define-project :name :steno_decoder
  :modules (list (make-instance 'module :name
                 ...
                 (make-instance 'module :name
                                "STENO_decoder_init.lisp")
                 (make-instance 'module :name
                                "..\\LISP - HPS STENO_ENCODER\\STENO_shared.lisp")
                 (make-instance 'module :name
                                "..\\LISP - HPS STENO_ENCODER\\STENO_segprinter.lisp")
                 (make-instance 'module :name "STENO_decoder_io.lisp")
                 (make-instance 'module :name "STENO_report.lisp")
                 (make-instance 'module :name "STENO_gnuplot.lisp")
                 (make-instance 'module :name "STENO_decoder.lisp")
                 (make-instance 'module :name
                                "STENO_decoder_iterative.lisp")
                 (make-instance 'module :name
                                "STENO_decoder_zdriver.lisp"))
  :projects nil
  :libraries nil
